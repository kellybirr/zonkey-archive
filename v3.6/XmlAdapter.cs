...
namespace Zonkey
{
    ...
    public class XmlAdapter : AdapterBase
    {
        ...
        public XmlDocument GetXmlDocument(string rootName, string nodeName, string sqlText, bool isProc, params object[] parameters)
        {
            XmlDocument xDoc = new XmlDocument();
            XmlElement xRoot = xDoc.CreateElement(rootName);
            xDoc.AppendChild(xRoot);

            FillXmlNode(xRoot, nodeName, sqlText, isProc, parameters);
            return xDoc;
        }
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1059:MembersShouldNotExposeCertainConcreteTypes", MessageId = "System.Xml.XmlNode")]
        public int FillXmlNode(XmlNode rootNode, string nodeName, string sqlText, bool isProc, params object[] parameters)
        {
