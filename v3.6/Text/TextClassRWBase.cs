...
namespace Zonkey.Text
{
        ...
        where T : class
    {
        ...
        /// <summary>
        /// Initialises the object from class metadata.
        /// </summary>
        public void Initialize()
        {
            var recAttr = TextRecordAttribute.GetFromTypeOrMember(typeof(T));
            RecordType = (recAttr != null) ? recAttr.RecordType : TextRecordType.Delimited;
            SequentialProperties = (recAttr != null) ? recAttr.SequentialProperties : false;
