...
namespace Zonkey.Text
{
        ...
        where T : class, new()
    {
        ...
        {
            Input = new StreamReader(path, encoding);
		}
		...
		/// <summary>
		/// Defined the behaviour of the reader when the line is shorter than the record length.
		/// </summary>
		/// <value>The short record behavoiur.</value>
		...
		{
			get { return (_csv != null) ? _csv.LineNumber : _lineNumber; }
		}
	}
