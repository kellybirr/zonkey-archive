...
namespace Zonkey
{
    ...
    public class SqlXmlAdapter : AdapterBase
    {
        ...
        public XmlDocument GetXmlDocument(string rootName, string sqlText, bool isProc, params object[] parameters)
        {
            var xDoc = new XmlDocument();
            XmlElement xRoot = xDoc.CreateElement(rootName);
            xDoc.AppendChild(xRoot);

            FillXmlNode(xRoot, sqlText, isProc, parameters);
            return xDoc;
        }
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1059:MembersShouldNotExposeCertainConcreteTypes", MessageId = "System.Xml.XmlNode")]
        public int FillXmlNode(XmlNode rootNode, string sqlText, bool isProc, params object[] parameters)
        {
        ...
        /// <param name="parameters">The parameters.</param>
        /// <returns></returns>
        public string GetXmlString(string sqlText, bool isProc, params object[] parameters)
        {
            var command = (SqlCommand)PrepareCommand(sqlText, isProc, parameters);
