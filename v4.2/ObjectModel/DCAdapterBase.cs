...
namespace Zonkey.ObjectModel
{
	...
	public abstract class DCAdapterBase<T> where T : class, new()
	{
		...
		{
			return BaseAdapter.Fill(collection, filterExpression);
		}
		...
		{
			return BaseAdapter.GetSingleItem(filterExpression);
		}
        ...
        {
            return BaseAdapter.GetCount(filterExpression);
        }
        ...
        {
            return BaseAdapter.Exists(filterExpression);
        }
		...
		{
			return BaseAdapter.Delete(filterExpression);
		}
		...
		{
			return BaseAdapter.OpenReader(filterExpression);
		}
	}
		...
		where T : class, new()
	{
		...
		{
			if (AuditSave == null)
				AuditSave(this, new DCSaveAuditEventArgs(audit));
		}
	}
