...
namespace Zonkey
{
    ...
    public class DataManager
    {
        ...
        public DataSet GetDataSet(string sql, CommandType commandType, params object[] parameters)
        {
            using (DbDataReader reader = GetDataReader(sql, commandType, parameters))
            {
                ...
                {
                    DataTable dt = new DataTable(string.Format("Table{0}", ++i));
        ...
        /// <param name="commandType">Type of command to execute</param>
        /// <param name="parameters">Parameter list required by the statement or stored procedure</param>
        public void FillDataTable(DataTable dt, string sql, CommandType commandType, params object[] parameters)
        {
            if (dt == null)
        ...
        /// <param name="parameters">The parameters.</param>
        /// <returns>The number of rows affected.</returns>
        public int ExecuteNonQuery(string sql, bool isProc, params object[] parameters)
        {
            if (sql == null)
                throw new ArgumentNullException("sql");
        ...
        /// <param name="parameters">The parameters.</param>
        /// <returns>The first column of the first row in the result set.</returns>
        public object ExecuteScalar(string sql, bool isProc, params object[] parameters)
        {
            if (sql == null)
                throw new ArgumentNullException("sql");
        ...
        public static DataView GetChildRelation(object dataItem, string relation)
        {
            ...
            if (drv != null) return drv.CreateChildView(relation);
            return null;
        }
        ...
        public static DbType GetDbType(Type type)
        {
            ...
            if ( (type == typeof(Int16)) || (type == typeof(Int16?)) ) 
                return DbType.Int16;
            if ( (type == typeof(Int32)) || (type == typeof(Int32?)) || (type.IsEnum) ) 
                return DbType.Int32;
