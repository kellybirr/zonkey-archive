...
namespace Zonkey
{
    public partial class DataClassAdapter<T>
    {
        ...
        public int FillRange(ICollection<T> collection, int start, int length, string filter, params object[] parameters)
        {
            if (filter == null)
        ...
        /// <returns></returns>
        public int FillRange(ICollection<T> collection, int start, int length, params SqlFilter[] filters)
        {
