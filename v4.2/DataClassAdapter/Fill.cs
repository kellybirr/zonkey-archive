...
namespace Zonkey
{
    public partial class DataClassAdapter<T>
    {
        ...
        public int FillAll(ICollection<T> collection)
        {
        ...
        public int Fill(ICollection<T> collection, Expression<Func<T, bool>> filterExpression)
        {
        ...
        /// <returns>the number of objects added to the collection</returns>
        public int Fill(ICollection<T> collection, params SqlFilter[] filters)
        {
        ...
        /// <returns>the number of objects added to the collection</returns>
        public int Fill(ICollection<T> collection, string filter)
        {
        ...
        /// <returns>the number of objects added to the collection</returns>
        public int Fill(ICollection<T> collection, string filter, params object[] parameters)
        {
            if (string.IsNullOrEmpty(filter))
                throw new ArgumentNullException("filter");
        ...
        /// <returns>the number of objects added to the collection</returns>
        public int Fill(ICollection<T> collection, DbCommand command)
        {
        ...
        /// <returns>the number of objects added to the collection</returns>
        public int Fill(ICollection<T> collection, DbDataReader reader)
        {
            if (collection == null) throw new ArgumentNullException("collection");
        ...
        /// <param name="parameters">The parameters.</param>
        /// <returns>the number of objects added to the collection</returns>
        public int FillWithSP(ICollection<T> collection, string storedProcName, params object[] parameters)
        {
